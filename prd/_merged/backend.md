# Merged content — prd/backend/

_6 file(s) combined on this page._


---

# backend-v1.md : backend

_Source: `prd/backend/backend-v1.md`_
...
# backend_combined_output.txt : backend

_Source: `prd/backend/backend_combined_output.txt`_
...
1. SES Setup
2. anymail integration to be done.

## For Admin

when the user signup successful.
when someone created a pickup request.
When someone places an order for the smart sell
When someone places an order for the self sell.
When an order is cancelled
When an order status is anything like payment failed or whatever

## For Seller

Welcome Email on signup successful.
Forgot password recovery email
to the seller, when he created a pickup request.
to the seller, when he change status of the pickup request.
to the seller, When an order status is anything like payment failed or whatever
...
Forgot password
    ...
    Email template - create simple email verification template

    url https://domainname.com/#/reset-password?u=uuid&token={newtoken}


==================================================
FILE: postgres-transition.md
==================================================

# Postgres Transition Tasks

- Install and enable PostGIS on PostgreSQL (local, staging, production) to support GIS/geo-spatial fields

- For GeoCoding pincodes model [ ]

  install for ubuntu
  sudo apt-get install gdal-bin

- import on logistics app models.py [ ]
...
# book-meta-data.md : backend

_Source: `prd/backend/book-meta-data.md`_
...
# checkout-to-verify.md : backend

_Source: `prd/backend/checkout-to-verify.md`_
...
# notifications-v1.md : backend

_Source: `prd/backend/notifications-v1.md`_
...
# postgres-transition.md : backend

_Source: `prd/backend/postgres-transition.md`_
